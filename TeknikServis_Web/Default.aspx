...
<html lang="zxx">
<head>
    <title>TEKNİK SERVİS VE ÜRÜN TAKİP PROJESİ</title>
...
<body>
    <div class="sidenav">
        <div class="row side_top">
            <div class="col-4 side_top_left">
                <img src="web/images/logo1.png" alt="news image" class="img-fluid navimg">
            </div>
    ...
    <div class="main" id="home">
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En ucuz ürün burada</h1>
                    <p class="banp mx-auto mt-3">25 kategoride yüzlerce ürün burada</p>
        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    ...
                    <p class="main_p mb-5  text-center mx-auto">Mağazadan almış olduğunuz ürünler 2 yıl servis garantisi kapsamındadır.</p>
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="WebForm1.aspx" role="button" style="background-color: blue">Arızalı Ürün Takibi</a>
                </div>
        ...
        <section class="wedo" id="contact">
            ...
            <p class="main_p mb-5  text-center mx-auto">Görüş,Öneri ve Şikayetlerinizi İletebilirsiniz.</p>
            <div class="contact_grid_right mt-5 mx-auto text-center">
                <form action="#" method="post">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınız" OnTextChanged="TextBox4_TextChanged" TextMode="MultiLine"></asp:TextBox>
            ...
            <div class="cpy-right text-center">
                ...
                <p>
                    © 2023 Teknik Servis. All rights reserved | Design by
					<a href="https://www.muhammedozdemir.net">Muhammed ÖZDEMİR</a>
                </p>
            </div>
        </section>
        <!-- //contact -->
